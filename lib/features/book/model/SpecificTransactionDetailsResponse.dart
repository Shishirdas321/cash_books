...
/// data : {"id":1,"opt_date":"2024-01-15","opt_time":"14:30","type":1,"amount":"1000.00","book_id":8,"contact_id":1,"category_id":1,"payment_mode_id":1,"remarks":"Sales payment from customer","status":1,"created_by":1,"updated_by":1,"created_at":"2025-09-02T08:07:31.000000Z","updated_at":"2025-09-02T08:07:31.000000Z","book":{"id":8,"name":"A4B Business","balance":"6477.00"},"contact":{"id":1,"name":"Jane Doe Up","mobile_no":"+0987654321"},"category":{"id":1,"name":"Administrative Expenses"},"payment_mode":{"id":1,"name":"Cash"},"creator":{"id":1,"first_name":"Tushar","last_name":"Das"},"updater":{"id":1,"first_name":"Tushar","last_name":"Das"}}

SpecificTransactionDetailsResponse specificTransactionDetailsResponseFromJson(String str) => SpecificTransactionDetailsResponse.fromJson(json.decode(str));
String specificTransactionDetailsResponseToJson(SpecificTransactionDetailsResponse data) => json.encode(data.toJson());
class SpecificTransactionDetailsResponse {
  SpecificTransactionDetailsResponse({
      this.success, 
      this.message, 
      this.data,});

  SpecificTransactionDetailsResponse.fromJson(dynamic json) {
...
/// updated_at : "2025-09-02T08:07:31.000000Z"
/// book : {"id":8,"name":"A4B Business","balance":"6477.00"}
...
class Data {
  ...
  Data.fromJson(dynamic json) {
    ...
    category = json['category'] != null ? Categoryee.fromJson(json['category']) : null;
...
Categoryee categoryFromJson(String str) => Categoryee.fromJson(json.decode(str));
String categoryToJson(Categoryee data) => json.encode(data.toJson());
class Categoryee {
  Categoryee({
      this.id, 
      this.name,});

  Categoryee.fromJson(dynamic json) {
    id = json['id'];
    name = json['name'];
  }
  int? id;
