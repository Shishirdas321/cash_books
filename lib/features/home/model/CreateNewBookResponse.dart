...
/// data : {"business_id":"9","name":"Cash Book","balance":"1000.00","status":1,"created_by":1,"updated_by":1,"updated_at":"2025-08-18T10:39:24.000000Z","created_at":"2025-08-18T10:39:24.000000Z","id":4,"business":{"id":9,"name":"A4B","status":1,"created_by":1,"updated_by":1,"created_at":"2025-08-12T07:01:10.000000Z","updated_at":"2025-08-12T07:01:10.000000Z"},"creator":{"id":1,"first_name":"Tushar","last_name":"Das","email":"tushar2499@gmail.com","phone":"+8801815920898","email_verified_at":null,"created_at":"2025-07-29T10:08:21.000000Z","updated_at":"2025-07-29T10:08:21.000000Z"},"updater":{"id":1,"first_name":"Tushar","last_name":"Das","email":"tushar2499@gmail.com","phone":"+8801815920898","email_verified_at":null,"created_at":"2025-07-29T10:08:21.000000Z","updated_at":"2025-07-29T10:08:21.000000Z"}}

CreateNewBookResponse createNewBookResponseFromJson(String str) => CreateNewBookResponse.fromJson(json.decode(str));
String createNewBookResponseToJson(CreateNewBookResponse data) => json.encode(data.toJson());
class CreateNewBookResponse {
  CreateNewBookResponse({
      this.success, 
      this.message, 
      this.data,});

  CreateNewBookResponse.fromJson(dynamic json) {
...
/// created_by : 1
/// updated_by : 1
/// updated_at : "2025-08-18T10:39:24.000000Z"
/// created_at : "2025-08-18T10:39:24.000000Z"
/// id : 4
