...
class AppTextStyles {
  ...
  static TextStyle appbar({Color? color, double? fontSize,FontWeight? fontWeight,}) =>
      _base(fontFamily: 'appBarText', defaultSize: 26.sp, defaultColor: Colors.white, color: color, fontSize: fontSize,fontWeight: fontWeight,);
  ...
  static TextStyle bodyMedium({Color? color, double? fontSize,FontWeight? fontWeight,TextDecoration? decoration,Color? decorationColor,double? decorationThickness,TextDecorationStyle? decorationStyle}) =>
      _base(fontFamily: 'popins', defaultSize: 20.sp, defaultColor: AppColors.themeColor, color: color, fontSize: fontSize,fontWeight: fontWeight,decoration: decoration,decorationColor: decorationColor,decorationThickness: decorationThickness,decorationStyle: decorationStyle);

  static TextStyle bodyMediumWhite({Color? color, double? fontSize,FontWeight? fontWeight,}) =>
      _base(fontFamily: 'popins', defaultSize: 15.sp, defaultColor: Colors.white, color: color, fontSize: fontSize,fontWeight: fontWeight,);

  static TextStyle titleSmall({Color? color, double? fontSize,FontWeight? fontWeight,}) =>
      _base(fontFamily: 'popins', defaultSize: 14.sp, defaultColor: AppColors.themeColor, color: color, fontSize: fontSize,fontWeight: fontWeight,);

  static TextStyle subtitleSmall({Color? color, double? fontSize,FontWeight? fontWeight,}) =>
      _base(fontFamily: 'appBarText', defaultSize: 13.sp, defaultColor: Colors.black, color: color, fontSize: fontSize,fontWeight: fontWeight,);

  static TextStyle bodyMediumPopins({Color? color, double? fontSize,FontWeight? fontWeight,}) =>
      _base(fontFamily: 'popins', defaultSize: 16.sp, defaultColor: Colors.white, color: color, fontSize: fontSize,fontWeight: fontWeight,);
}
